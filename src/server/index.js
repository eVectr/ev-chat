...
///////////////////////////// API //////////////////////////////////////////////////
    ...
    socket.emit('delete_p2p_counter', delete_data)
})
...
socket.on('send_Counter', counter_data =>{
    conversation.setp2pcounter(counter_data.counter, counter_data.receiver, counter_data.sender )
    .then(res =>{
       console.log("receive p2p  counterrr response", res)
    })
